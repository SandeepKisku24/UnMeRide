  ...
  require 'connection.php';
    if(isset($_POST['log'])){
      $latitude = $_POST["latitude"];
              ...
              $query1 ="INSERT INTO rider VALUES('','','','','','','','','$latitude','$longitude')";
              mysqli_query($connect,$query1);
        $query = "select * from rider where email ='$_POST[email]' AND psw = '$_POST[psw]'";
    ...
    <div class="box1">
      ...
      <form class="myForm" method="post">
        ...
        <div class="container" style= "background-color:#E8F9FD; margin-left:170px; margin-bottom:10px">
          ...
          New User? <a href="register1.php">Start here</a>
        </div>
      </form>
    </div>
