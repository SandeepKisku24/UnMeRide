...
if(isset($_POST['log'])){
  ...
  $rno = $_POST["rno"];
  $psw = $_POST["psw"];
  $query ="INSERT INTO users VALUES('','$name','$pno','$email','$ad1','$ad2','$car','$dvl','$rno','$psw','','','')";
  mysqli_query($connect,$query);
  echo"<script>alert('data entered');
  document.location.href='login_page.php' </script>";
}
else{
...
.box{
  ...
  <div class="container signin">
    <p>Already have an account? <a href="login_page.php"<!DOCTYPE html>
    <html lang="en" dir="ltr">
      <head>
        <meta charset="utf-8">
        <title></title>
